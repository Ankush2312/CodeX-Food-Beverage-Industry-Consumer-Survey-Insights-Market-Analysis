# Set Tried_Before to "No" where Heard_Before is "No" 
update fact_survey_responses
set tried_before = "No"
where heard_before = "No";

# Nullify Current_Brands for respondents who never heard/tried and had CodeX 
update fact_survey_responses
set current_brands = null
where heard_before="No" and tried_before="No" and current_brands="CodeX";
